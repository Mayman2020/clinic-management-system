...
export class UserProfileService {
  ...
  changeMyPassword(payload: ChangePasswordRequest): Observable<ApiResponse<void>> {
    return this.api.post<ApiResponse<void>>(AppConstants.API.USERS_ME_CHANGE_PASSWORD, payload);
  }
}
