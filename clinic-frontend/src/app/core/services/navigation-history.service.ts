...
/** Tracks in-app navigation so the page header back button only appears after drill-down. */
...
export class NavigationHistoryService {
  ...
  /** Call before sidebar / top-level menu navigation — clears back affordance on the target page. */
  markFromMenu(): void {
